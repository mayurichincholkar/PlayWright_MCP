...
async def run():
    try:
        # Start the Playwright MCP server in headed mode with isolated profile
        async with MCPServerStdio(
            ...
            params={
                ...
                "args": [
                    ...
                    # "--headless"  # Run in headless mode (remove for visible browser)
                ],
            },
            client_session_timeout_seconds=60.0,  # Increased from 5 to 60 seconds
